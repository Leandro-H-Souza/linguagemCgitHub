...
void geraSenha(int comprimento, int maiuscula, int minuscula, int num, int caracEspecial){
    ...
    if(caracEspecial){
        ...
        printf("N�o h� como gerar uma senha.\n");
        return 1;
    }
...
int main(){
    ...
    do{
            printf("Forne�a o n�mero de carateres: \n");
            scanf(" %d", &comprimento);
            printf("Incluir letras maisculas (1- Sim, 0- N�o)?\n");
            scanf(" %d", &maiuscula);
        ...
        printf("Gostaria de gerar uma nova senha (1- Sim, 0- N�o)?\n");
        scanf(" %d", &novasenha);
    }
    while(novasenha != 0);
